  ...
  <div class="flex flex-col w-full h-full">
    <div class="overview">
      ...
      <section v-if="relations.length">
        ...
        <MediaRelationCard :data="data?.anime_relation_relations_as_anime" :count-show="12" />
      </section>

      <!-- Characters Section -->
      <section v-if="characters.length">
        <h2 class="overview-title">Character</h2>
        <MediaCharacterCard :data="data?.anime_characters_voice_actor_relations" :count-show="6" />
      </section>

      <!-- Staff Section -->
      <section v-if="staffs.length">
        <h2 class="overview-title">Staff</h2>
        <MediaStaffCard :data="data?.anime_staff_relations" :count-show="6" />
      </section>
