...
<template>
	<div class="center">
		<div class="design" :style="{ height: height + 'px', width: width + 'px' }">
				...
				<div class="circle-2 center color-border">
					<div class="circle-3 center color-border">
						<div class="circle-4 center color-border">
							<div class="circle-5">
								<div class="in-circle-1 in-circle"></div>
								<div class="in-circle-2 in-circle"></div>
								<div class="in-circle-3 in-circle"></div>
							</div>
						</div>
					</div>
				</div>
