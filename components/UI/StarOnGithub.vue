<template>
  <button class="star-github-button">
    <div class="star-github-content">
...
.star-github-button:hover {
  transform: scale(1.05);
}

.star-github-button:active {
  transform: scale(0.95);
}

/* Focus styles */
.star-github-button:focus-visible {
  outline: none;
  box-shadow: 0 0 0 2px var(--ring-color, #3b82f6), 0 0 0 4px var(--ring-offset-color, #fff);
}

/* Disabled state */
.star-github-button:disabled {
  pointer-events: none;
  opacity: 0.5;
}
...
.star-github-button:hover .star-icon {
  color: #fbbf24;
}
